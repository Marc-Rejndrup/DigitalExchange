...
System.out.println("StudentInformation");
		...
		try {
			...
			java.sql.ResultSet rs = stmt1.executeQuery("select Holding.StockSymbol, Holding.Amount from Holding, Client where Client.Id=Holding.AccountId ");
